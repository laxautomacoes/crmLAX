        ...
        >
            {!hasError ? (
                <img 
                    ...
                    className={`w-full h-full object-cover transition-all duration-200 ${
                        isSelected 
                            ? 'ring-2 ring-[#FFE600] ring-offset-1 ring-offset-background scale-[0.98]' 
                ...
                <div className={`w-full h-full flex flex-col items-center justify-center p-2 text-center bg-muted/40 transition-all duration-200 ${
                    isSelected ? 'ring-2 ring-[#FFE600] ring-offset-1 ring-offset-background scale-[0.98]' : ''
                }`}>
            ...
            <div className={`absolute inset-0 flex items-center justify-center transition-all duration-200 ${
                ...
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all duration-200 ${
                    isSelected ? 'bg-[#FFE600] border-[#FFE600] scale-110' : 'border-white/70 bg-black/30'
                }`}>
                    {isSelected && <Check size={12} className="text-[#404F4F] stroke-[3]" />}
                </div>
            </div>
