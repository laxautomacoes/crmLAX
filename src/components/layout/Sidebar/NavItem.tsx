                        ...
                        {item.subItems.map((sub: any) => {
                            ...
                            return (
                                <Link
                                    ...
                                    onClick={onClose}
                                    className={`block px-3 py-2 text-base rounded-lg transition-colors ${subActive ? 'bg-white/10 text-secondary font-medium' : 'text-sidebar-foreground/50 hover:text-sidebar-foreground'}`}
                                >
                                    {sub.name}
                                </Link>
                            );
