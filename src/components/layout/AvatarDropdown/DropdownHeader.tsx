...
export function DropdownHeader({ profile }: DropdownHeaderProps) {
    return (
        <div className="flex items-center gap-4 p-4 border-b border-border bg-muted">
            <UserAvatar
            ...
            <div className="flex flex-col min-w-0">
                ...
                <div className="flex flex-col gap-1 mt-1">
                    <span className="text-[10px] uppercase tracking-wider font-bold text-secondary-foreground bg-secondary px-1.5 py-0.5 rounded w-fit">
