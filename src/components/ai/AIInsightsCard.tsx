...
export default function AIInsightsCard({ tenantId, profileId, period, hasAIAccess }: AIInsightsCardProps) {
            ...
            <div className="flex items-center justify-between gap-4 rounded-2xl border border-[#FFE600]/30 bg-gradient-to-r from-secondary/5 to-[#FFE600]/10 p-5">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Análise inteligente dos seus dados de crescimento e conversão.</p>
                    </div>
                </div>
        ...
        return (
            <div className="flex items-center justify-between gap-4 rounded-2xl border border-border bg-card p-5">
                ...
                >
                    ...
                    {loading ? 'Analisando...' : 'Gerar Análise Inteligente'}
                </button>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-4 rounded-2xl border border-border bg-card p-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="flex items-start gap-3 rounded-xl border border-[#FFE600]/30 bg-[#FFE600]/10 p-4">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{insights.recommendation}</p>
                </div>
            </div>
        </div>
    );
