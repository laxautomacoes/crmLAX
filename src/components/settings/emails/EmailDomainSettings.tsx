    ...
    return (
        <div className="w-full">
            <div 
                ...
                className="flex items-center justify-between cursor-pointer group mb-6 sm:mb-3 sm:ml-1"
            >
                <div className="flex items-center gap-3">
                    ...
                    {!isExpanded && domain && (
                        <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-[10px] font-bold border transition-all ${verified ? 'bg-green-500/10 border-green-500/20 text-green-500' : 'bg-yellow-500/10 border-yellow-500/20 text-yellow-500'}`}>
                ...
                <div className={`p-1.5 rounded-lg bg-muted/50 text-muted-foreground group-hover:bg-muted group-hover:text-foreground transition-all duration-300 ${isExpanded ? 'rotate-180' : ''}`}>
                    <ChevronDown size={18} />
                </div>
            </div>
