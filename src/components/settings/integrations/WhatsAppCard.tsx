            ...
            >
                <div className="p-5 bg-muted/30 flex flex-col gap-3">
                    <div className="flex items-start justify-between mb-1">
                        <div className="p-2.5 rounded-xl bg-[#25D366]/10 text-[#25D366] w-fit">
                            <WhatsAppIcon size={22} />
                        </div>
                        <span className={`flex h-2.5 w-2.5 rounded-full ${isConnected ? 'bg-emerald-500' : 'bg-red-500'}`} />
                    </div>
                    <div className="flex flex-col gap-1">
                        <h3 className="text-sm font-bold text-foreground line-clamp-1">WhatsApp</h3>
