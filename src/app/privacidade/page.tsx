...
export const metadata: Metadata = {
    title: 'Política de Privacidade | CRM LAX - LAX Automações',
    description: 'Política de Privacidade da plataforma CRM LAX, operada pela LAX Automações LTDA. Saiba como coletamos, utilizamos e protegemos seus dados pessoais.',
    robots: {
        index: true,
        follow: true,
    },
        ...
        <div className="min-h-screen bg-[#0A0D0D] text-white selection:bg-[#FFE600] selection:text-[#404F4F]">
            ...
            <main className="pt-32 pb-24 px-6">
                <div className="container mx-auto max-w-[800px]">
                    ...
                    <div className="text-center mb-16 space-y-6">
                        <div className="inline-flex items-center justify-center p-4 bg-[#FFE600]/10 rounded-lg mb-4">
                        ...
                        <p className="text-gray-400 text-lg max-w-2xl mx-auto font-medium">
                            {laxPrivacyPolicy.company} — Sua privacidade é a nossa prioridade. Entenda como protegemos seus dados na plataforma CRM LAX.
                        </p>
                        ...
                        <p className="text-gray-500 text-sm">Última atualização: {laxPrivacyPolicy.lastUpdated}</p>
                    </div>

                    {/* Content Card */}
                    <div className="bg-[#1A2020] border border-white/10 rounded-lg p-8 md:p-12 shadow-2xl relative overflow-hidden">
                        {/* Decorative element */}
                        <div className="absolute top-0 right-0 w-64 h-64 bg-[#FFE600]/5 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2" />

                        <div className="relative z-10 space-y-10">
                            {laxPrivacyPolicy.sections.map((section, index) => (
                                <section key={index} className="space-y-4">
                                    <h2 className="text-xl font-bold text-[#FFE600]/90 tracking-tight">
                                        {section.title}
                                    </h2>
                                    <div className="text-gray-300 leading-relaxed whitespace-pre-wrap font-medium text-[15px]">
                                        {section.content}
                                    </div>
                                    {index < laxPrivacyPolicy.sections.length - 1 && (
                        ...
                        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
                            <div className="text-gray-500 text-sm">
                                Última atualização: <span className="text-gray-400 font-bold">{laxPrivacyPolicy.lastUpdated}</span>
                            </div>
                            <Link
                                href="/conheca"
                                className="bg-[#FFE600] text-[#404F4F] px-8 py-3 rounded-lg text-sm font-bold hover:bg-[#F2DB00] transition-all transform active:scale-95 shadow-lg shadow-[#FFE600]/10"
                            >
                                Voltar ao Início
                            </Link>
                        </div>
            ...
            <footer className="py-12 border-t border-white/5 text-center">
                <p className="text-gray-600 text-xs font-bold uppercase tracking-widest">
                    &copy; {new Date().getFullYear()} CRM LAX - LAX Automações LTDA
                </p>
            </footer>
        </div>
    );
