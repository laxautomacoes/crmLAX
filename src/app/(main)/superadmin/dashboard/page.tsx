...
export default async function SuperadminDashboardPage() {
    ...
    try {
        ...
        const stats = [
            ...
            { label: 'Total de Usuários', value: userCount, icon: User },
        ...
        console.error('[SuperadminDashboard] Erro ao carregar dashboard:', error)
        return (
            <div className="space-y-8">
                <PageHeader 
                    title="Painel de Controle" 
                ...
                <div className="p-8 text-center">
                    <p className="text-muted-foreground">Erro ao carregar dados do dashboard. Tente novamente.</p>
