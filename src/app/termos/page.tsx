        ...
        <div className="container mx-auto max-w-[800px]">
          ...
          >
            <div className="inline-flex items-center justify-center p-4 bg-[#FFE600]/10 rounded-2xl mb-4">
              <FileText className="text-[#FFE600] w-12 h-12" />
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Termos de Uso</h1>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto font-medium">
              Regras e diretrizes para o uso ético e produtivo da plataforma CRM LAX.
            </p>
            <div className="flex items-center justify-center gap-6 text-xs font-bold uppercase tracking-widest text-gray-500">
              <span className="flex items-center gap-2"><Scale size={14} className="text-[#FFE600]" /> Base Jurídica</span>
              <span className="flex items-center gap-2"><CheckCircle2 size={14} className="text-[#FFE600]" /> Uso Autorizado</span>
            </div>
          </motion.div>
          ...
          >
            {/* Decorative element */}
            <div className="absolute top-0 left-0 w-64 h-64 bg-[#FFE600]/5 rounded-full blur-[80px] -translate-y-1/2 -translate-x-1/2" />
