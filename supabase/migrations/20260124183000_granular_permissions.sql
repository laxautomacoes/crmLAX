-- Add name and permissions to invitations
ALTER TABLE public.invitations 
ADD COLUMN IF NOT EXISTS name TEXT,
ADD COLUMN IF NOT EXISTS permissions JSONB DEFAULT '{"dashboard":true,"leads":true,"clients":true,"properties":true,"calendar":true,"reports":true,"settings":false}'::jsonb;

-- Add permissions to profiles
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS permissions JSONB DEFAULT '{"dashboard":true,"leads":true,"clients":true,"properties":true,"calendar":true,"reports":true,"settings":false}'::jsonb;

-- Update handle_new_user function to copy permissions
